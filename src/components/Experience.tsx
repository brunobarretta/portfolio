  ...
  return (
    <section id='experience' className='pb-10'>
      ...
      <VerticalTimeline>
        ...
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: 'rgb(55 65 81)', boxShadow: '0 4px 0 rgb(33, 150, 243)' }}
          contentArrowStyle={{ borderRight: '7px solid  rgb(55 65 81)' }}
          date="02/2022 - 09/2022"
          iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
          icon={<FaSuitcase />}
        >
          <h3 className="text-lg font-bold text-gray-200">{t('experience.job_one')}</h3>
          <h4 className="text-md font-bold text-gray-300">KPEyes</h4>
          <h4 className="text-md text-gray-300">{t('experience.city_idt')}</h4>
          <p className='text-gray-200'>
        ...
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: 'rgb(55 65 81)', boxShadow: '0 4px 0 rgb(148, 33, 243)' }}
          contentArrowStyle={{ borderRight: '7px solid  rgb(55 65 81)' }}
          date="2019 - 2021"
          iconStyle={{ background: 'rgb(148, 33, 243)', color: '#fff' }}
          icon={<FaGlobeAsia />}
        >
          <h3 className="text-lg font-bold text-gray-200">{t('experience.career_break')}</h3>
          <h4 className="text-md text-gray-300">{t('experience.city_ngy')}</h4>
          <p className='text-gray-200'>
        ...
        <VerticalTimelineElement
          ...
          contentStyle={{ background: 'rgb(55 65 81)', boxShadow: '0 4px 0 rgb(233, 30, 99)' }}
          contentArrowStyle={{ borderRight: '7px solid  rgb(55 65 81)' }}
          date="2015 - 2017"
          iconStyle={{ background: 'rgb(233, 30, 99)', color: '#fff' }}
          icon={<FaGraduationCap />}
        >
          <h3 className="text-lg font-bold text-gray-200">{t('experience.education_course')}</h3>
          <h4 className="text-md font-bold text-gray-300">{t('experience.education_college_name')}</h4>
          <h4 className="text-md font-bold text-gray-300">{t('experience.education_type')}</h4>
          <h4 className="text-md text-gray-300">{t('experience.city_idt')}</h4>
        </VerticalTimelineElement>
        <VerticalTimelineElement
